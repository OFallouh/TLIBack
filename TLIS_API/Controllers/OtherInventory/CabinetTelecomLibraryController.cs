...
namespace TLIS_API.Controllers.OtherInventory
{
    ...
    public class CabinetTelecomLibraryController : ControllerBase
    {
        ...
        {
            var response = _unitOfWorkService.OtherInventoryLibraryService.GetForAdd(Helpers.Constants.OtherInventoryType.TLIcabinetTelecomLibrary.ToString());
            return Ok(response);
        }
        ...
        {
            var ConnectionString = _configuration["ConnectionStrings:ActiveConnection"];
            var response = await _unitOfWorkService.OtherInventoryLibraryService.Disable(Id, Helpers.Constants.OtherInventoryType.TLIcabinetTelecomLibrary.ToString(), ConnectionString);
            return Ok(response);
        }
        ...
        {
            var ConnectionString = _configuration["ConnectionStrings:ActiveConnection"];
            var response = await _unitOfWorkService.OtherInventoryLibraryService.Delete(Id, Helpers.Constants.OtherInventoryType.TLIcabinetTelecomLibrary.ToString(), ConnectionString);
            return Ok(response);
        }
    }
}