...
namespace TLIS_Service.Services
{
    public class CivilLibraryService : ICivilLibraryService
    {
                    ...
                    using (TransactionScope transaction = new TransactionScope())
                    {
                        try
                        {
                            ...
                            if (Helpers.Constants.CivilType.TLIcivilWithLegLibrary.ToString() == TableName)
                            {
                                ...
                                {
                                    _unitOfWork.DynamicAttLibRepository.AddDynamicLibAtt(AddCivilWithLegsLibraryObject.dynamicAttributes, TableNameEntity.Id, CivilWithLegEntites.Id);
                                }
        ...
        public async Task<Response<EditCivilWithLegsLibraryObject>> EditCivilWithLegsLibrary(EditCivilWithLegsLibraryObject editCivilWithLegsLibrary, string TableName,int userId)
        {
                                   ...
                                   new System.TimeSpan(0, 15, 0)))
            {
                try
                {
                    ...
                    EditLogisticalItem(editCivilWithLegsLibrary.logisticalItems, CivilWithLegLibraryEntites, TableNameEntity.Id, OldLogisticalItemIds);
        ...
        public async Task<Response<EditCivilWithoutLegsLibraryObject>> EditCivilWithoutlegsLibrary(EditCivilWithoutLegsLibraryObject editCivilWithoutLegsLibraryObject, string TableName, int userId)
        {
                                   ...
                                   new System.TimeSpan(0, 15, 0)))
            {
                try
                {
                    ...
                    if (CivilWithLegLib.Model != CivilWithLegLibraryEntites.Model)
                    {
                        return new Response<EditCivilWithoutLegsLibraryObject>(true, null, null, $"Can not Edit model", (int)Helpers.Constants.ApiReturnCode.fail);
                    }
                    ...
                    EditLogisticalItem(editCivilWithoutLegsLibraryObject.logisticalItems, CivilWithLegLibraryEntites, TableNameEntity.Id, OldLogisticalItemIds);
        ...
        public void EditLogisticalItem(AddLogisticalViewModel LogisticalItemIds, dynamic MainEntity, int TableNameEntityId, AddLogisticalViewModel OldLogisticalItemIds)
        {
            ...
            try
            {
                ...
                listofAttributesActivated
                    ...
                    .Select(FKitem =>
                    {
                        ...
                        {
                            FKitem.Options = _mapper.Map<List<CivilSteelSupportCategoryViewModel>>(_unitOfWork.CivilWithoutLegCategoryRepository.GetWhere(x =>!x.disable).ToList());
            ...
            try
            {
                ...
                if (AttributeFilters != null && AttributeFilters.Count > 0)
                {
                    ...
                    WithoutDateFilterCivilWithoutLegLibraries = _mapper.Map<List<CivilWithoutLegLibraryViewModel>>(_unitOfWork.CivilWithoutLegLibraryRepository.GetIncludeWhere(x =>
                        ...
                        x => x.structureType, x => x.CivilSteelSupportCategory, x => x.InstCivilwithoutLegsType, x => x.CivilWithoutLegCategory).ToList());
                }
                ...
                if (AfterConvertDateFilters != null ? AfterConvertDateFilters.Count() > 0 : false)
                {
                    ...
                    WithDateFilterCivilWithoutLegLibraries = _mapper.Map<List<CivilWithoutLegLibraryViewModel>>(_unitOfWork.CivilWithoutLegLibraryRepository.GetIncludeWhere(x =>
                        ...
                        x => x.InstCivilwithoutLegsType, x => x.structureType).ToList());
                }
                    ...
                    (AfterConvertDateFilters != null ? AfterConvertDateFilters.Count() == 0 : true))
                {
                    CivilWithoutLegLibraries = _mapper.Map<List<CivilWithoutLegLibraryViewModel>>(_unitOfWork.CivilWithoutLegLibraryRepository.GetIncludeWhere(x =>
                        ...
                        x => x.structureType, x => x.InstCivilwithoutLegsType).ToList());
                }
