...
namespace TLIS_Service.Services
{
    public class SideArmLibraryService : ISideArmLibraryService
    {
        ...
        public SideArmLibraryService(IUnitOfWork unitOfWork, IServiceCollection services, IMapper mapper, ApplicationDbContext DbContext)
        {
        ...
        public Response<ReturnWithFilters<object>> GetSideArmLibrariesWithEnabledAttributes(CombineFilters CombineFilters, ParameterPagination parameterPagination, bool? isRefresh)
        {
            ...
            try
            {
                    ...
                    (isRefresh != null ? isRefresh.Value : false))
                {
                    ...
                    _SideArmLibraryEntities = _DbContext.TLIsideArmLibrary
                        .AsNoTracking()
                ...
                {
                    SideArmLibraryAttribute = UnitOfWork.AllAttributeViewManagment.Where(x =>
