...
namespace TLIS_Service.Services
{
    public class ConfigurationAttsService : IConfigurationAttsService
    {
        ...
        //public async Task<Response<ConfigurationAttsViewModel>> Update(ConfigurationAttsViewModel viewModel,string TabelName)
        //{
        //    try
        //    {
        //        if (string.IsNullOrWhiteSpace(viewModel.Name) || string.IsNullOrEmpty(viewModel.Name))
        ...
        public async Task<Response<List<TableAffected>>> Delete(string TabelName, int RecordId, int UserId, string ListName)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new Response<List<TableAffected>>(true, null, null, ex.Message, (int)Helpers.Constants.ApiReturnCode.fail);
            }
        }
