                            ...
                            TLIloadOther LoadOther = _mapper.Map<TLIloadOther>(LoadOtherViewModel.installationAttributes);
                                        ...
                                        if (AllcivilinstId != null)
                                        {
                                            if (LoadOtherViewModel.installationConfig.legId != null)
                                            {
                                                ...
                                                if (Leg != null)
                                                {
                                                    ...
                                                    var Data = _unitOfWork.CivilWithLegsRepository.FilterAzimuthAndHeight(SiteCode, LoadOtherViewModel.installationConfig.legId
                                                      , null, LoadOtherViewModel.installationConfig.civilWithLegId, null, null, null, null, LoadOther.Azimuth
                                                      , LoadOther.HeightBase, 1).Data;
                                                    ...
                                                    var sortedIds = _unitOfWork.CivilWithLegsRepository.ProcessDynamicAttributes(LoadOtherViewModel, HistoryId);

                                                    if (LoadOtherViewModel.dynamicAttribute != null && LoadOtherViewModel.dynamicAttribute.Count > 0)
                                                    {
                                                        var sortedDynamicAttributes = LoadOtherViewModel.dynamicAttribute
                                                            .OrderBy(item => sortedIds.IndexOf(item.id))
                                                            .ToList();

                                                        foreach (var item in sortedDynamicAttributes)
                                                        {
                                                            var Message = _unitOfWork.CivilWithLegsRepository.CheckDynamicValidationAndDependence(item.id, item.value, LoadOther.Id, HistoryId).Message;
                                                            if (Message != "Success")
                                                            {
                                ...
                                if (LoadOtherViewModel.installationConfig.InstallationPlaceId == 2)
                                {
                                    if (LoadOtherViewModel.installationConfig.civilSteelType == 0)
                                    {
                                        ...
                                        {
                                            AllcivilinstId = _unitOfWork.CivilSiteDateRepository.GetIncludeWhereFirst(x => x.allCivilInst.civilWithLegsId ==
                                               LoadOtherViewModel.installationConfig.civilWithLegId && !x.Dismantle && x.SiteCode.ToLower() == SiteCode.ToLower(), x => x.allCivilInst, x => x.allCivilInst.civilWithLegs,
                                                    ...
                                                    if (LoadOtherViewModel.installationConfig.sideArmId != null)
                                                    {
                                                        ...
                                                        if (SideArm != null)
                                                        {
                                                            ...
                                                            if (AllcivilinstId != null)
                                                            {
                                                                ...
                                                                var Data = _unitOfWork.CivilWithLegsRepository.FilterAzimuthAndHeight(SiteCode, LoadOtherViewModel.installationConfig.legId
                                                                , null, LoadOtherViewModel.installationConfig.civilWithLegId, LoadOtherViewModel.installationConfig.civilWithoutLegId
                                                                , LoadOtherViewModel.installationConfig.civilNonSteelId, LoadOtherViewModel.installationConfig.sideArmId, null, LoadOther.Azimuth
                                                                , LoadOther.HeightBase, 2).Data;
                                    ...
                                    if (LoadOtherViewModel.installationConfig.civilSteelType == 1)
                                    {
                                        if (LoadOtherViewModel.installationConfig.civilWithoutLegId != null)
                                        {
                                            AllcivilinstId = _unitOfWork.CivilSiteDateRepository.GetIncludeWhereFirst(x => x.allCivilInst.civilWithoutLegId ==
                                              LoadOtherViewModel.installationConfig.civilWithoutLegId && !x.Dismantle && x.SiteCode.ToLower() == SiteCode.ToLower(), x => x.allCivilInst, x => x.allCivilInst.civilWithLegs, x => x.allCivilInst.civilWithoutLeg,
                                              x => x.allCivilInst.civilWithLegs.CivilWithLegsLib, x => x.allCivilInst.civilWithoutLeg.CivilWithoutlegsLib);
                                    ...
                                    if (LoadOtherViewModel.installationConfig.civilSteelType == 2)
                                    {
                                        if (LoadOtherViewModel.installationConfig.civilNonSteelId != null)
                                        {
                                            AllcivilinstId = _unitOfWork.CivilSiteDateRepository.GetIncludeWhereFirst(x => x.allCivilInst.civilNonSteelId ==
                                               LoadOtherViewModel.installationConfig.civilNonSteelId && !x.Dismantle && x.SiteCode.ToLower() == SiteCode.ToLower(), x => x.allCivilInst, x => x.allCivilInst.civilWithLegs, x => x.allCivilInst.civilWithoutLeg,
                                               x => x.allCivilInst.civilWithLegs.CivilWithLegsLib, x => x.allCivilInst.civilWithoutLeg.CivilWithoutlegsLib);
                                            if (AllcivilinstId != null)
                                            {
                                                if (LoadOtherViewModel.installationConfig.sideArmId != null)
        ...
        public async Task<Response<GetForAddMWDishInstallationObject>> EditLoadOtherInstallation(EditLoadOtherInstallationObject LoadOtherViewModel, int? TaskId,int UserId,string ConnectionString)
        {
            using (TransactionScope transaction = new TransactionScope())
            {
                try
                {
                    ...
                    var TableNameId = _unitOfWork.TablesNamesRepository.GetWhereFirst(x => x.TableName.ToLower() == TablesNames.TLIloadOther.ToString().ToLower()).Id;
                       ...
                       .FirstOrDefault(x => x.allLoadInstId != null && x.allLoadInst.loadOtherId == loadOther.Id && !x.Dismantle);
                        ...
                        if (LoadOtherViewModel.installationConfig.InstallationPlaceId == 1)
                        {
                            ...
                            {
                                AllcivilinstId = _unitOfWork.CivilSiteDateRepository.GetIncludeWhereFirst(x => x.allCivilInst.civilWithLegsId ==
                                LoadOtherViewModel.installationConfig.civilWithLegId && !x.Dismantle && x.SiteCode.ToLower() == loadOtherInst.SiteCode.ToLower(), x => x.allCivilInst, x => x.allCivilInst.civilWithLegs, x => x.allCivilInst.civilWithoutLeg,
                                x => x.allCivilInst.civilWithLegs.CivilWithLegsLib, x => x.allCivilInst.civilWithoutLeg.CivilWithoutlegsLib);
                                if (AllcivilinstId != null)
                                {
                                    if (LoadOtherViewModel.installationConfig.legId != null)
                                    {
                                        ...
                                        if (Leg != null)
                                        {
                                            ...
                                            var Data = _unitOfWork.CivilWithLegsRepository.EditFilterAzimuthAndHeight(null, null, null,
                                             null, null, null, null, null, loadOther.Id, null,null, "TLIloadOther", loadOtherInst.SiteCode, LoadOtherViewModel.installationConfig.legId
                                            , null, LoadOtherViewModel.installationConfig.civilWithLegId, null, null, null, null, loadOther.Azimuth
                                            , loadOther.HeightBase, 1).Data;
                                            ...
                                            var CheckName = _dbContext.MV_LOAD_OTHER_VIEW.FirstOrDefault(x =>
                                                ...
                                                {
                                                    var EquivalentSpace = loadOther.SpaceInstallation * (loadOther.CenterHigh / (float)AllcivilinstId.allCivilInst.civilWithLegs.HeightBase);
                                                    AllcivilinstId.allCivilInst.civilWithLegs.CurrentLoads -= loadOtherInst.allLoadInst.loadOther.EquivalentSpace;
                                                    AllcivilinstId.allCivilInst.civilWithLegs.CurrentLoads += EquivalentSpace;
                                                    loadOther.EquivalentSpace = EquivalentSpace;
                                                    var Message = _unitOfWork.CivilWithLegsRepository.CheckAvailableSpaceOnCivils(AllcivilinstId.allCivilInst).Message;
                        ...
                        else if (LoadOtherViewModel.installationConfig.InstallationPlaceId == 2)
                        {
                            if (LoadOtherViewModel.installationConfig.civilSteelType == 0)
                            {
                                if (LoadOtherViewModel.installationConfig.civilWithLegId != null)
                                {
                                    ...
                                    AllcivilinstId = _unitOfWork.CivilSiteDateRepository.GetIncludeWhereFirst(x => x.allCivilInst.civilWithLegsId ==
                                   LoadOtherViewModel.installationConfig.civilWithLegId && !x.Dismantle && x.SiteCode.ToLower() == loadOtherInst.SiteCode.ToLower(), x => x.allCivilInst, x => x.allCivilInst.civilWithLegs,
                                   x => x.allCivilInst.civilWithoutLeg, x => x.allCivilInst.civilWithLegs.CivilWithLegsLib, x => x.allCivilInst.civilWithoutLeg.CivilWithoutlegsLib);
                                    if (AllcivilinstId != null)
                                    {
                                        if (LoadOtherViewModel.installationConfig.legId != null)
                            ...
                            else if (LoadOtherViewModel.installationConfig.civilSteelType == 1)
                            {
                                ...
                                {
                                    AllcivilinstId = _unitOfWork.CivilSiteDateRepository.GetIncludeWhereFirst(x => x.allCivilInst.civilWithoutLegId ==
                                      LoadOtherViewModel.installationConfig.civilWithoutLegId && !x.Dismantle && x.SiteCode.ToLower() == loadOtherInst.SiteCode.ToLower(), x => x.allCivilInst, x => x.allCivilInst.civilWithLegs, x => x.allCivilInst.civilWithoutLeg,
                                      x => x.allCivilInst.civilWithLegs.CivilWithLegsLib, x => x.allCivilInst.civilWithoutLeg.CivilWithoutlegsLib);
                                            ...
                                            if (SideArm != null)
                                            {
                                               ...
                                               , loadOther.HeightBase, 2).Data;
                                                ...
                                                var CheckName = _dbContext.MV_LOAD_OTHER_VIEW.FirstOrDefault(x =>
                                                    ...
                                                    {
                                                        var EquivalentSpace = loadOther.SpaceInstallation * (loadOther.CenterHigh / (float)AllcivilinstId.allCivilInst.civilWithoutLeg.HeightBase);
                                                        AllcivilinstId.allCivilInst.civilWithoutLeg.CurrentLoads -= loadOtherInst.allLoadInst.loadOther.EquivalentSpace;
                                                        AllcivilinstId.allCivilInst.civilWithoutLeg.CurrentLoads += EquivalentSpace;
                                                        loadOther.EquivalentSpace = EquivalentSpace;
                                                        var Message = _unitOfWork.CivilWithLegsRepository.CheckAvailableSpaceOnCivils(AllcivilinstId.allCivilInst).Message;
                            ...
                            else if (LoadOtherViewModel.installationConfig.civilSteelType == 2)
                            {
                                ...
                                {
                                    AllcivilinstId = _unitOfWork.CivilSiteDateRepository.GetIncludeWhereFirst(x => x.allCivilInst.civilNonSteelId ==
                                       LoadOtherViewModel.installationConfig.civilNonSteelId && !x.Dismantle && x.SiteCode.ToLower() == loadOtherInst.SiteCode.ToLower(), x => x.allCivilInst, x => x.allCivilInst.civilWithLegs, x => x.allCivilInst.civilWithoutLeg,
                                       x => x.allCivilInst.civilWithLegs.CivilWithLegsLib, x => x.allCivilInst.civilWithoutLeg.CivilWithoutlegsLib);
                                    if (AllcivilinstId != null)
                                    {
                                        if (LoadOtherViewModel.installationConfig.sideArmId != null)
                                        {
                                            ...
                                            if (LoadOtherViewModel.dynamicAttribute != null && LoadOtherViewModel.dynamicAttribute.Count > 0)
                                            {
                                                ...
                                                foreach (var item in sortedDynamicAttributes)
                                                {
                                                    var Messagee = _unitOfWork.CivilWithLegsRepository.EditCheckDynamicValidationAndDependence(item.id, item.value, loadOther.Id, HistoryId).Message;
                                                    if (Messagee != "Success")
                                                    {
                    ...
                    if (LoadOtherViewModel.installationConfig.civilWithLegId != null)
                    {
                        _unitOfWork.CivilWithLegsRepository.RecalculatSpace(Convert.ToInt32(LoadOtherViewModel.installationConfig.civilWithLegId), "TLIcivilWithLegs");
                    }
                    else if (LoadOtherViewModel.installationConfig.civilWithoutLegId != null)
                    {
                        _unitOfWork.CivilWithLegsRepository.RecalculatSpace(Convert.ToInt32(LoadOtherViewModel.installationConfig.civilWithoutLegId), "TLIcivilWithoutLeg");
                    }
                    else if (LoadOtherViewModel.installationConfig.civilNonSteelId != null)
                    {
                        _unitOfWork.CivilWithLegsRepository.RecalculatSpace(Convert.ToInt32(LoadOtherViewModel.installationConfig.civilWithLegId), "TLIcivilNonSteel");
                    }
                    Task.Run(() => _unitOfWork.CivilWithLegsRepository.RefreshView(ConnectionString));
                    return new Response<GetForAddMWDishInstallationObject>();
                }
                ...
                try
                {
                    if (LoadName == Helpers.Constants.TablesNames.TLImwDish.ToString())
                    {
                        ...
                        if (DishLoad != null)
                        {
                            ...
                            _unitOfWork.MW_DishRepository.Update(DishLoad.allLoadInst.mwDish);
                            _unitOfWork.SaveChanges();
                    ...
                    else if (LoadName == Helpers.Constants.TablesNames.TLImwODU.ToString())
                    {
                        ...
                        if (ODULoad != null)
                        {
                            ...
                            ODULoad.allLoadInst.mwODU.Name = ODULoad.allLoadInst.mwODU.Name + DateTime.Now;
                            ...
                            _unitOfWork.MW_ODURepository.Update(ODULoad.allLoadInst.mwODU);
                            _unitOfWork.SaveChanges();
                    ...
                    else if (LoadName == Helpers.Constants.TablesNames.TLIradioRRU.ToString())
                    {
                        ...
                        if (RadioRRULoad != null)
                        {
                            ...
                            _unitOfWork.RadioRRURepository.Update(RadioRRULoad.allLoadInst.radioRRU);
                            _unitOfWork.SaveChanges();
                    ...
                    else if (LoadName == Helpers.Constants.TablesNames.TLIpower.ToString())
                    {
                        ...
                        if (PowerLoad != null)
                        {
                            ...
                            PowerLoad.allLoadInst.power.Name = PowerLoad.allLoadInst.power.Name + DateTime.Now;
                            ...
                            _unitOfWork.PowerRepository.Update(PowerLoad.allLoadInst.power);
                            _unitOfWork.SaveChanges();
                    ...
                    else if (LoadName == Helpers.Constants.TablesNames.TLIloadOther.ToString())
                    {
                        ...
                        if (OtherLoad != null)
                        {
                            ...
                            _unitOfWork.LoadOtherRepository.Update(OtherLoad.allLoadInst.loadOther);
                            _unitOfWork.SaveChanges();
                    ...
                    else if (LoadName == Helpers.Constants.TablesNames.TLIradioAntenna.ToString())
                    {
                        ...
                        if (RadioAntennaLoad != null)
                        {
                           ...
                           .ToList();
                            ...
                            _unitOfWork.RadioAntennaRepository.Update(RadioAntennaLoad.allLoadInst.radioAntenna);
                            _unitOfWork.SaveChanges();
                    ...
                    else if (LoadName == Helpers.Constants.TablesNames.TLImwBU.ToString())
                    {
                        ...
                        if (MWBULoad != null)
                        {
                            ...
                            _unitOfWork.MW_BURepository.Update(MWBULoad.allLoadInst.mwBU);
                            _unitOfWork.SaveChanges();
                    ...
                    else if (LoadName == Helpers.Constants.TablesNames.TLImwRFU.ToString())
                    {
                        ...
                        if (MWRFULoad != null)
                        {
                            ...
                            _unitOfWork.MW_RFURepository.Update(MWRFULoad.allLoadInst.mwRFU);
                            _unitOfWork.SaveChanges();
                    ...
                    else if (LoadName == Helpers.Constants.TablesNames.TLImwOther.ToString())
                    {
                        ...
                        if (MWOtherLoad != null)
                        {
                            ...
                            _unitOfWork.Mw_OtherRepository.Update(MWOtherLoad.allLoadInst.mwOther);
                            _unitOfWork.SaveChanges();
                    ...
                    else if (LoadName == Helpers.Constants.TablesNames.TLIradioOther.ToString())
                    {
                        ...
                        if (RdioOtherLoad != null)
                        {
                            ...
                            _unitOfWork.RadioOtherRepository.Update(RdioOtherLoad.allLoadInst.radioOther);
                            _unitOfWork.SaveChanges();
