...
namespace TLIS_Service.IService
{
    public interface ISiteService
    {
        ...
        Response<IEnumerable<SiteViewModel>> GetSites(string ConnectionString, ParameterPagination parameterPagination, bool? isRefresh, bool? isUsed, List<FilterObjectList> filters = null);
