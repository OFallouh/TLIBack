...
namespace TLIS_Service.IService
{
    public interface ISiteService
    {
        ...
        Response<IEnumerable<SiteViewModel>> GetSites(string ConnectionString, ParameterPagination parameterPagination, bool? isRefresh, List<FilterObjectList> filters = null);
