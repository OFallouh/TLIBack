...
namespace TLIS_Service.IService
{
    public interface ISiteService
    {
        ...
        Response<IEnumerable<SiteViewModelForGetAll>> GetSites(ParameterPagination parameterPagination, bool? isRefresh, bool? isUsed, bool? GetItemsCountOnEachSite, List<FilterObjectList> filters = null);
