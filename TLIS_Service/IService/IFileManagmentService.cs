...
namespace TLIS_Service.IService
{
    public interface IFileManagmentService
    {
        ...
        Response<string> AttachFile(int UserId, IFormFile file, int documenttypeId, string Model, string Name, string SiteCode, string RecordId, string TableName, string connection, string AttachFolder, string asset);
        ...
        Response<IEnumerable<AttachedFilesViewModel>> GetFilesByRecordIdAndTableName(int RecordId, string TableName, string SiteCode);
        Response<List<AttachedFilesViewModel>> GetAttachecdFilesBySite(string SiteCode);
    }
}
