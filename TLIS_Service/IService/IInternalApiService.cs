...
namespace TLIS_Service.IService
{
    public interface IInternalApiService
    {
        ...
        Response<bool> DismantleLoads(string sitecode, int LoadId, string LoadName);
        ...
        Response<bool> DismantleSideArm(string SiteCode, int sideArmId);
        ...
        Response<bool> DismantleOtherInventory(string SiteCode, int OtherInventoryId, string OtherInventoryName);
