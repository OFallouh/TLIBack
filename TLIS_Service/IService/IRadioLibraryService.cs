...
namespace TLIS_Service.IService
{
    public interface IRadioLibraryService
    {
        ...
        Response<AddRadioOtherLibraryObject> AddRadioOtherLibrary(string TableName, AddRadioOtherLibraryObject addRadioOtherLibraryObject, string connectionString, int UserId, bool ExternalSys);
        ...
        Response<AddRadioRRULibraryObject> AddRadioRRULibrary(string TableName, AddRadioRRULibraryObject RadioLibraryViewModel, string connectionString, int UserId, bool ExternalSys);
        Response<GetEnableAttribute> GetRadioAntennaLibrariesEnabledAtt(string ConnectionString);
        Response<AddRadioAntennaLibraryObject> AddRadioAntennaLibrary(string TableName, AddRadioAntennaLibraryObject RadioLibraryViewModel, string connectionString, int UserId, bool ExternalSys);
