...
namespace TLIS_Service.IService
{
    public interface IMWLibraryService
    {
        ...
        Response<AddMWOtherLibraryObject> AddMWOtherLibrary(int UserId, string TableName, AddMWOtherLibraryObject addMWOtherLibraryObject, string connectionString,bool ExternalSys);
        Task<Response<EditMWOtherLibraryObject>> EditMWOtherLibrary(int userId, EditMWOtherLibraryObject editMWOtherLibraryObject, string TableName, string connectionString, bool ExternalSys);
        Response<GetEnableAttribute> GetMWOtherLibrariesEnabledAtt(string ConnectionString);
        Task<Response<EditMWRFULibrary>> EditMWRFULibrary(int userId, EditMWRFULibrary editMWRFULibraryAttributes, string TableName, string connectionString, bool ExternalSys);
        Response<AddMWRFULibraryObject> AddMWRFULibrary(int UserId, string TableName, AddMWRFULibraryObject addMWRFULibraryObject, string connectionString, bool ExternalSys);
        ...
        Response<AddMWBULibraryObject> AddMWBULibrary(int UserId, string TableName, AddMWBULibraryObject addMWBULibraryObject, string connectionString, bool ExternalSys);
        Task<Response<EditMWBULibraryObject>> EditMWBULibrary(int userId, EditMWBULibraryObject editMWBULibrary, string TableName, string connectionString, bool ExternalSys);
        Task MW_ODULibrarySeedDataForTest();
        Task MW_DishLibrarySeedDataForTest();
        Task<Response<EditMWODULibraryObject>> EditMWODULibrary(int userId, EditMWODULibraryObject editMWODULibraryObject, string TableName,string connectionString, bool ExternalSys);
        Response<ADDMWODULibraryObject> AddMWODULibrary(int UserId, string TableName, ADDMWODULibraryObject aDDMWODULibraryObject, string connectionString, bool ExternalSys);
        Task<Response<EditMWDishLibraryObject>> EditMWDishLibrary(int userId, EditMWDishLibraryObject editMWDishLibraryObject, string TableName, string connectionString, bool ExternalSys);
        ...
        Response<GetForAddCivilLibrarybject> GetById(int Id, string TableNam,int UserId, bool ExternalSys);
        ...
        Response<GetForAddCivilLibrarybject> GetForAdd(string TableNam, int UserId, bool ExternalSys);
        Response<AddMWDishLibraryObject> AddMWDishLibrary(int UserId, string TableName, AddMWDishLibraryObject addMWDishLibraryObject, string connectionString,bool ExternalSys);
