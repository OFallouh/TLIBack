...
{
    public class RadioOtherLibraryRepository: RepositoryBase<TLIradioOtherLibrary, RadioOtherLibraryViewModel, int>, IRadioOtherLibraryRepository
    {
        private readonly ApplicationDbContext _context;
        IMapper _mapper;
        public RadioOtherLibraryRepository(ApplicationDbContext context, IMapper mapper):base(context,mapper)
        {
            _context = context;
            _mapper = mapper;
        }
