...
{
    public class CabinetPowerLibraryRepository: RepositoryBase<TLIcabinetPowerLibrary, CabinetPowerLibraryViewModel, int>, ICabinetPowerLibraryRepository
    {
        private readonly ApplicationDbContext _context;
        IMapper _mapper;
        public CabinetPowerLibraryRepository(ApplicationDbContext context, IMapper mapper):base(context, mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        public List<KeyValuePair<string, List<DropDownListFilters>>> GetRelatedTables()
        {
            ...
            RelatedTables.Add(new KeyValuePair<string, List<DropDownListFilters>>("IntegratedWith", rfuTypeList));
