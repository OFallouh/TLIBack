...
{
    public class RadioRRULibraryRepository: RepositoryBase<TLIradioRRULibrary, RadioRRULibraryViewModel, int>, IRadioRRULibraryRepository
    {
        private readonly ApplicationDbContext _context;
        IMapper _mapper;
        public RadioRRULibraryRepository(ApplicationDbContext context, IMapper mapper):base(context,mapper)
        {
            _context = context;
            _mapper = mapper;
        }
