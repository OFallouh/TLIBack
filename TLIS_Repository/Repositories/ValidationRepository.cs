...
namespace TLIS_Repository.Repositories
{
    public class ValidationRepository : RepositoryBase<TLIvalidation, ValidationViewModel, int>, IValidationRepository
    {
        ...
        //                    if (Rule.DynamicAttribute.tablesNamesId == TableNameId)
        //                    {
        //                        dynamicAttributeInstValue = addCivilNonSteel.dynamicAttribute.Where(x => x.id == Rule.DynamicAttribute.Id).FirstOrDefault();
        //                        if (Operation.Name.ToLower() == "required")
        //                        {
        //                            if (dynamicAttributeInstValue == null)
        //                            {
        ...
        //                        if (Rule.DynamicAttribute.LibraryAtt == true)
        //                        {
        //                            dynamicAttLibValue = _context.TLIdynamicAttLibValue.Where(x => x.DynamicAttId == Rule.DynamicAttribute.Id && x.tablesNamesId == Rule.DynamicAttribute.tablesNamesId && x.InventoryId == addCivilNonSteel.civilType.civilNonSteelLegsLibId).FirstOrDefault();
        //                            if (Operation.Name.ToLower() == "required")
        //                            {
        //                                if (dynamicAttLibValue == null)
        //                                {
        ...
        //                {
        //                    var Operation = Operations.Where(x => x.Id == Rule.Rule.OperationId).FirstOrDefault();
        //                    var dynamicAttribute = addCivilWithLegLibrary.dynamicAttribute.Where(x => x.id == Rule.DynamicAttribute.Id).FirstOrDefault();
        //                    if (Operation.Name.ToLower() == "required")
        //                    {
        ...
        //            var ForeignKeys = new Dictionary<string, string>();
        //            ForeignKeys.Add("TLIcivilSteelSupportCategory", "CivilSteelSupportCategoryId");
        //            ForeignKeys.Add("TLIinstallationCivilwithoutLegsType", "InstCivilwithoutLegsTypeId");
        ...
        //                {
        //                    var Operation = Operations.Where(x => x.Id == Rule.Rule.OperationId).FirstOrDefault();
        //                    var dynamicAttribute = addCivilWithoutLegLibrary.dynamicAttribute.Where(x => x.id == Rule.DynamicAttribute.Id).FirstOrDefault();
        //                    if (Operation.Name.ToLower() == "required")
        //                    {
        //                        if (dynamicAttribute == null)
        //                        {
        ...
        //                {
        //                    var Operation = Operations.Where(x => x.Id == Rule.Rule.OperationId).FirstOrDefault();
        //                    var dynamicAttribute = addCivilNonSteelLibrary.dynamicAttribute.Where(x => x.id == Rule.DynamicAttribute.Id).FirstOrDefault();
        //                    if (Operation.Name.ToLower() == "required")
        //                    {
        //                        if (dynamicAttribute == null)
        //                        {
