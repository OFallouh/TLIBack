...
{
    public class ListStepActionViewModel
    {
        ...
        public List<ListStepActionGroupViewModel> StepActionFileGroup { get; set; }
        public List<ListStepActionGroupViewModel> StepActionGroup { get; set; }
