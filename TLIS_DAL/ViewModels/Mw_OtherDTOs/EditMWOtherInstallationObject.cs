...
{
    public class EditMWOtherInstallationObject
    {
        public EditInstallationMWOtherConfigObject installationConfig { get; set; }
        public AddCivilLoad civilLoads { get; set; }
        public LibraryAttributesMWOtherObject civilType { get; set; }
        public EditInstallationMWOtherAttributeObject installationAttributes { get; set; }
        public List<AddDdynamicAttributeInstallationValueViewModel> dynamicAttribute { get; set; }
        public class LibraryAttributesMWOtherObject
        {
            public int mwOtherLibraryId { get; set; }

        }
        public class EditInstallationMWOtherAttributeObject
        {
        ...
        public class EditInstallationMWOtherConfigObject
        {
