...
{
    public class AddRadioAntennaInstallationObject
    {
        public InstallationRadioAntennaConfigObject installationConfig { get; set; }
        public AddCivilLoad civilLoads { get; set; }
        public InstallationRadioAntennaAttributeObject installationAttributes { get; set; }
        public List<AddDdynamicAttributeInstallationValueViewModel> dynamicAttribute { get; set; }
        public class InstallationRadioAntennaAttributeObject
        {
        ...
        public class InstallationRadioAntennaConfigObject
        {
