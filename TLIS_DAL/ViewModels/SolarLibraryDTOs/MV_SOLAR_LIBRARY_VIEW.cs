...
{
    public class MV_SOLAR_LIBRARY_VIEW
    {
        ...
        public Dictionary<string, object> GenerateOutputData()
        {
            ...
            outputData.Add("TotaPanelsDimensions", TotaPanelsDimensions);
            ...
            outputData.Add("StructureDesign", StructureDesign);
            outputData.Add("HeightFromFront", HeightFromFront);
            outputData.Add("HeightFromBack", HeightFromBack);
            outputData.Add("BasePlateDimension", BasePlateDimension);
