...
{
    public class EditRadioOtherInstallationObject
    {
        public EditInstallationRadioOtherConfigObject installationConfig { get; set; }
        public AddCivilLoad civilLoads { get; set; }
        public LibraryAttributesRadioOtherObject civilType { get; set; }
        public EditInstallationRadioOtherAttributeObject installationAttributes { get; set; }
        public List<AddDdynamicAttributeInstallationValueViewModel> dynamicAttribute { get; set; }
        public class LibraryAttributesRadioOtherObject
        {
            public int radioOtherLibraryId { get; set; }

        }
        public class EditInstallationRadioOtherAttributeObject
        {
        ...
        public class EditInstallationRadioOtherConfigObject
        {
