...
using static TLIS_DAL.ViewModels.MW_RFUDTOs.AddMWRFUInstallation;
using static TLIS_DAL.ViewModels.MW_RFUDTOs.EditMWRFUInstallationObject;
    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
           ...
           // ---------------------------------------------------------------------------------------
            ...
            CreateMap<LoadandsidearmViewDto, TLIpower>().ReverseMap();
            ...
            CreateMap<EditCabinetPowerLibraryAttributes, TLIcabinetPowerLibrary>().ReverseMap();
            ...
            CreateMap<TLIcabinetPowerLibrary, object>().ReverseMap();
            CreateMap<TLIcabinetTelecomLibrary, TLIcabinetTelecomLibrary>().ReverseMap();
            CreateMap<TLIcabinetTelecomLibrary, object>().ReverseMap();
            CreateMap<TLIsolarLibrary, TLIsolarLibrary>().ReverseMap();
            CreateMap<TLIsolarLibrary, object>().ReverseMap();
            CreateMap<TLIgeneratorLibrary, TLIgeneratorLibrary>().ReverseMap();
            CreateMap<TLIgeneratorLibrary, object>().ReverseMap();
            ...
            CreateMap<TLIuser, UserDto>().ReverseMap();
            ...
            CreateMap<EditCivilNonSteelLibraryAttributes, TLIcivilNonSteelLibrary>().ReverseMap();
...
.ReverseMap();
            ...
            CreateMap<TLIlogUsersActions, TLIlogUsersActionsViewModel>() 
                .ForMember(x => x.UserName, x => x.MapFrom(f => f.User.UserName)).ReverseMap();
